...
def calculates_results_stats(results_dic):
    ...
    for filename, value in results_dic.items():
        ...
        results_stats_dic["n_notdogs_img"] += 1 - value[3]
        results_stats_dic["n_match"] += value[2]
        results_stats_dic["n_correct_dogs"] += value[3] * value[4]
        results_stats_dic["n_correct_notdogs"] += (1 - value[3]) * (1 - value[4])
        results_stats_dic["n_correct_breed"] += value[2] * value[3]
